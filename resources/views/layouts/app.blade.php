...
<head>
    ...
    @include('layouts.components.icon-logo')
                ...
                <div>
                    ...
                    @role('administrador')
                        <div class="w-full">
                            <a href="{{ route('admin.employees.index') }}"
                                class=" min-h-[40px] py-3 pr-4 pl-8 flex justify-start items-center transition ease-out duration-500 gap-3 hover:bg-[#8E9FAE] {{ Request::is('admin/employees') ? 'active' : '' }}">
                                <div>
                        ...
                        <div class="w-full">
                            <a href="{{ route('admin.restaurants.index') }}"
                                class="min-h-[40px] py-3 pr-4 pl-8 flex justify-start items-center transition ease-out duration-500 gap-3 hover:bg-[#8E9FAE] {{ Request::is('admin/restaurants') ? 'active' : '' }}">
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-white" viewBox="0 0 183 189"
                        ...
                        <div class="w-full">
                            <a href="{{ route('admin.positions.index') }}"
                                class="min-h-[40px] py-3 pr-4 pl-8 flex justify-start items-center transition ease-out duration-500 gap-3 hover:bg-[#8E9FAE] {{ Request::is('admin/positions') ? 'active' : '' }}">
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 fill-white"
                                        viewBox="0 0 512 512">
                                        <path
                        ...
                        <div class='flex-col'>
                            <div class="w-full">
                                <a href="{{ route('admin.measures.index') }}"
                                    class="min-h-[40px] py-3 pr-4 pl-8 flex justify-start items-center transition ease-out duration-500 gap-3 hover:bg-[#8E9FAE] {{ Request::is('admin/measures') ? 'active' : '' }}">
                                    <div class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 fill-white"
                                            viewBox="0 0 512 512">
                                            <path
                            ...
                            <div class="w-full">
                                <a href="{{ route('admin.ingredients.index') }}"
                                    class="min-h-[40px] py-3 pr-4 pl-8 flex justify-start items-center transition ease-out duration-500 gap-3 hover:bg-[#8E9FAE] {{ Request::is('admin/ingredients') ? 'active' : '' }}">
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 fill-white"
                                            viewBox="0 0 512 512">
                                            <path
                            ...
                            <div class="w-full">
                                <a href="{{ route('admin.categories.index') }}"
                                    class="min-h-[40px] py-3 pr-4 pl-8 flex justify-start items-center transition ease-out duration-500 gap-3 hover:bg-[#8E9FAE] {{ Request::is('admin/categories') ? 'active' : '' }}">
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 fill-white"
                                            viewBox="0 0 448 512">
                                            <path
                    ...
                    @role(['administrador', 'editor', 'chefe-de-cozinha', 'degustador'])
                        <div class="dashboard-nav-dropdown relative flex flex-col">
                            ...
                            <div class='dashboard-nav-dropdown-menu hidden flex-col'>
                                @role(['administrador', 'chefe-de-cozinha'])
                                    <div class="w-full pl-8">
                            ...
                            <div class='dashboard-nav-dropdown-menu hidden flex-col'>
                                @role(['administrador', 'editor'])
                                    <div class="w-full pl-8">
                                        <a href="{{ route('publications.publish.cookbooks') }}"
                                            class="dashboard-nav-dropdown-item min-h-[40px] pt-2 pr-4 pb-2 pl-6 flex justify-start items-center transition ease-out duration-500 gap-3 hover:bg-[#8E9FAE] {{ Request::is('publications/publish/cookbooks') ? 'active' : '' }}">
                                            <div class="dashboard-nav-dropdown-item-container">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 fill-white"
                                                    viewBox="0 0 512 512">
                                                    <path
                                    ...
                                    <div class="w-full pl-8">
                                        <a href="{{ route('publications.my-publications.cookbooks') }}"
                                            class="dashboard-nav-dropdown-item min-h-[40px] pt-2 pr-4 pb-2 pl-6 flex justify-start items-center transition ease-out duration-500 gap-3 hover:bg-[#8E9FAE] {{ Request::is('publications/my-publications/cookbooks') ? 'active' : '' }}">
                                            <div class="dashboard-nav-dropdown-item-container">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 fill-white"
                                                    viewBox="0 0 512 512">
                                                    <path
                                ...
                                <div class="w-full pl-8">
                                    <a href="{{ route('publications.all-publications.cookbooks') }}"
                                        class="dashboard-nav-dropdown-item min-h-[40px] pt-2 pr-4 pb-2 pl-6 flex justify-start items-center transition ease-out duration-500 gap-3 hover:bg-[#8E9FAE] {{ Request::is('/publications/all-publications/cookbooks') ? 'active' : '' }}">
                                        <div class="dashboard-nav-dropdown-item-container">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 fill-white"
                                                viewBox="0 0 512 512">
                                                <path
