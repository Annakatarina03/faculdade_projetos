                    ...
                    <div class="pb-2.5 col-span-2">
                        ...
                        <div class=" max-h-[410px] overflow-y-auto">
                            @foreach ($employees_restaurant as $index => $employee_restaurant)
                                <div class="flex items-center">
                                    <div class="flex flex-col gap-2 w-96 py-2">
                                        <div class="relative w-5/6">
                                            <div class="pb-2">
                                                ...
                                                <input type="text"
                                                    name="employees_restaurant-{{ $index }}-restaurant"
                                        ...
                                        <div class="flex flex-col md:flex-row gap-3">
                                            <div class="relative w-5/12">
                                                <div class="pb-2.5">
                                                    ...
                                                    <input name="employees_restaurant-{{ $index }}-date_entry"
                                                        ...
                                                        type="date" max="{{ date('Y-m-d') }}" disabled
                                                        @class([
                                                            'bg-[#EEE]',
                                                            'shadow-inner',
                                                            'mb-2',
                                            ...
                                            @if ($employees_restaurant[$index]['resignation_date'])
                                                <div class="relative w-5/12">
                                                    <div class="pb-2.5">
                                                        <label class="block mb-2 text-sm font-medium text-gray-900">
                                                            Data de demissão
