            ...
            <div class="grid gap-2 mb-1 md:grid-cols-4">
                    ...
                    <div class="pb-2.5">
                        ...
                        <select name="office" wire:model.live="office" @class([
                            ...
                            @foreach ($positions as $office)
                                <option id="{{ $office->slug }}">{{ $office->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    @error('office')
                ...
                <div class="relative md:grid md:col-span-2">
                    <div class="pb-2.5">
                        ...
                        <input type="password" name="password" wire:model.live="password"
                            @class([
                                'bg-gray-50',
                                'mb-2',
                                'border-1',
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="pt-3">
                                    <button wire:click.prevent="del({{ $index }})"
                                        class="flex items-center justify-center bg-red-700 text-white focus:ring-4 focus:outline-none focus:ring-red-300 font-medium text-sm px-2 py-2 text-center rounded-md"
                                        title="Deletar">
