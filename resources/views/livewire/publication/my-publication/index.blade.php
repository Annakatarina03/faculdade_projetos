                    ...
                    @if (!$cookbook->revenues->isEmpty())
                        <div
                            ...
                            <div class="flex items-center justify-center space-x-4">
                                <a href="{{ route('publications.publish.cookbooks-edit', ['cookbook' => $cookbook]) }}"
                                ...
                                <a href="{{ route('publications.publish.cookbooks-show', ['cookbook' => $cookbook]) }}"
                                ...
                                <button
                                    wire:click="openModal('publication.publish.form-delete', {'id' : {{ $cookbook->id }}})"
