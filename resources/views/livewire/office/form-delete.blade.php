<div class="relative w-full p-4 h-full md:h-auto">
    <div>
        ...
        <div class="flex justify-center  rounded-t">
            <p class="mb-4 text-gray-500">Você deseja mesmo excluir o cargo
        ...
        @if ($is_employees)
            <div class="flex justify-center items-center gap-2 rounded-t">
                ...
                <p class="text-red-500 font-bold">Existem funcionários vinculados a essse cargo.</p>
            </div>
        @endif
    </div>
        ...
        <div class="flex justify-center items-center space-x-4">
            ...
            @if (!$is_employees)
                <button wire:click="delete({{ $office }})" @class([
                    ...
                    'bg-red-600',
                    'rounded-lg',
                    'hover:bg-red-700' => !$is_employees,
                    'focus:ring-4',
                    'focus:outline-none',
                    'focus:ring-red-300',
                    'cursor-not-allowed' => $is_employees,
                    'bg-red-400' => $is_employees,
                ])>
