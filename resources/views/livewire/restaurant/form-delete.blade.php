<div class="relative w-full p-4 h-full md:h-auto">
    <div>
        ...
        <div class="flex justify-center  rounded-t">
            <p class="mb-4 text-gray-500">Você deseja mesmo excluir esse restaurante?</p>
        </div>
        @if ($has_employees)
            <div class="flex justify-center items-center gap-2 rounded-t">
                ...
                <p class="text-red-500 font-bold">Existem funcionários vinculados a essse restaurante.</p>
            </div>
        @endif
    </div>
    <div class="relative p-4 text-center bg-white sm:p-5">
        <div class="flex justify-center items-center space-x-4">
            ...
            @if (!$has_employees)
                <button wire:click="delete({{ $restaurant }})"
