<div class="w-full">
    <div class="flex py-4 rounded-t border-b">
        <h3 class="text-lg font-semibold text-gray-900">Marcar degustação</h3>
    </div>
    <form wire:submit="create" method="POST" class="py-2">
        ...
        <div class="grid gap-2 mb-1 md:grid-cols-4">
            <div class="relative md:col-span-4">
                <div class="pb-2.5">
                    <label for="taster_name" class="block mb-2 text-sm font-medium text-gray-900">Degustador</label>
                    <input type="text" name="taster_name" wire:model.live="taster_name" @class([
                        'bg-[#EEE]',
                        'shadow-inner',
                        'mb-2',
                        'border-1',
            ...
            <div class="relative md:grid md:col-span-4">
                <div class="pb-2.5">
                    <label for="date_entry" class="block mb-2 text-sm font-medium text-gray-900">
                        Data da degustação <span class="text-red-500" title="Campo obrigatório">*</span>
                    </label>
                    <input wire:model.live="tasting_date" type="date" min="{{ date('Y-m-d') }}"
                        @class([
                            'bg-gray-50',
                            'mb-2',
                            'border-1',
