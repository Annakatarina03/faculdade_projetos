...
@section('content')
    <div class="w-full px-8 py-2">
        ...
        <form action="{{ route('publications.publish.cookbooks-store', ['cookbook' => $cookbook]) }}" method="POST"
                ...
                <div class="w-full grid gap-2 md:grid-cols-5">
                    ...
                    <div class="md:col-span-5">
                        <div class="relative flex flex-col">
                            ...
                            @enderror
                            <div class="pt-6">
                                <livewire:publication.publish.create.revenue-list :cookbook="$cookbook" />
                            </div>
                        </div>
                    </div>
                </div>
