        ...
        <form method="POST" action="{{ route('employees.update', ['employee' => $employee->id]) }}">
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                <div class="sm:col-span-2">
                    <label for="name" class="block mb-2 text-sm font-medium text-gray-900">Nome do funcionário</label>
                ...
                <div class="w-full">
                    <label for="username"
                        class="block mb-2 text-sm font-medium text-gray-900">Usuário</label>
                ...
                <div>
                    ...
                    <select id="office" name="office"
                        ...
                        @foreach ($positions as $office)
                            <option value="{{ $office->id }}" {{ $employee->office->slug === $office->slug ? "selected" : "" }}>{{$office->description}}</option>
                        @endforeach
                    </select>
                    @error('office')
                    <div class="flex items-center gap-2 py-1">
                ...
                <div>
                    <label for="date_entry" class="block mb-2 text-sm font-medium text-gray-900">Data de admisssão</label>
