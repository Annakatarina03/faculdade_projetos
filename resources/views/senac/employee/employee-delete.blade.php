    ...
    <div x-show="modelOpen" class="fixed md:top-5 inset-0 z-10" aria-labelledby="modal-title" role="dialog"
        ...
        <div class="flex justify-center">
            <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                ...
                class="inline-block md:w-2/12 max-w-xl p-8 
                overflow-hidden text-left transition-all my-60 transform bg-white rounded-lg shadow-xl 2xl:max-w-2xl">
                <form method="POST" action="{{ route('admin.employees.destroy', ['employee' => $employee->id]) }}">
                    ...
                    <p class="mb-4 text-sm text-center text-black font-bold">Deseja apagar esse funcionário?</p>
