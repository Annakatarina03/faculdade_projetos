    ...
    <div x-show="modelOpen" class="fixed md:top-5 inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title"
        ...
        <div class="flex items-end justify-center  min-h-screenpx-4 text-center md:items-center sm:block sm:p-0">
            ...
            <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                ...
                class="inline-block w-full max-w-xl p-8 my-20 md:my-40 text-left transition-all transform bg-white rounded-lg shadow-xl 2xl:max-w-2xl">
...
<script type="module">
    import $ from 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/3/jquery.inputmask.bundle.js'
