<div x-data="{ modelOpen: @if (count($errors) !== 0) true @else false @endif }" class="flex justify-center">
    ...
    <div x-show="modelOpen" class="absolute top-0 md:fixed md:top-5 md:inset-0 z-20" aria-labelledby="modal-title"
        role="dialog" aria-modal="true">
        <div x-cloak @click="modelOpen = false" x-show="modelOpen"
            x-transition:enter="transition ease-out duration-300 transform" x-transition:enter-start="opacity-0"
            x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-200 transform"
            x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0"
            class="md:fixed md:inset-0 transition-opacity bg-gray-500 bg-opacity-40" aria-hidden="true">
        </div>
        ...
        <div class="flex justify-center">
            <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                ...
                class="p-8 w-screen text-left transition-all transform my-20 sm:w-6/12 md:w-6/12 md:my-28 bg-white md:rounded-lg shadow-xl">
                ...
                <form method="POST" action="{{ route('admin.employees.store') }}">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div class="relative">
                            ...
                            <input type="text" name="name"
                                ...
                                placeholder="Nome do funcionário" value="{{ old('name') }}">
                            @error('name')
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="cpf"
                                class="cpf bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                placeholder="CPF do funcionário" value="{{ old('cpf') }}">
                            @error('cpf')
                                <div class="flex items-center gap-2 py-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 fill-red-600"
                                        viewBox="0 0 512 512">
                        ...
                        <div>
                            ...
                            <input type="text" name="username"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                placeholder="Usuário do funcionário" value="{{ old('username') }}">
                            @error('username')
                                <div class="flex items-center gap-2 py-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 fill-red-600"
                                        viewBox="0 0 512 512">
                        ...
                        <div>
                            ...
                            <select name="office"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 peer">
                                <option disabled selected="">Selecione o cargo</option>
                                @foreach ($positions as $office)
                                    <option value="{{ $office->slug }}">{{ $office->description }}</option>
                                @endforeach
                            </select>
                            @error('office')
                                <div class="flex items-center gap-2 py-1">
                        ...
                        <div>
                            ...
                            <input type="number" name="wage"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                placeholder="$2999" value="{{ old('wage') }}">
                            @error('wage')
                                <div class="flex items-center gap-2 py-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 fill-red-600"
                                        viewBox="0 0 512 512">
                        ...
                        <div>
                            <label for="password_confirmation"
                                class="block mb-2 text-sm font-medium text-gray-900">Confirmação da senha</label>
                    ...
                    <div class="items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                        ...
                        <button @click="location.reload()" type="reset"
                            class="w-full justify-center sm:w-auto text-white inline-flex items-center bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-200">
